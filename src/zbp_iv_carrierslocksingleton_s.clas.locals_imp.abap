...
CLASS lhc_Carrier IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    DATA: airline_ids TYPE SORTED TABLE OF ZIV_carrier WITH UNIQUE KEY AirlineID.

    READ ENTITIES OF ZIV_CarriersLockSingleton_S IN LOCAL MODE
      ENTITY Carrier
        FIELDS ( AirlineID )
...
CLASS lsc_ZIV_CARRIERSLOCKSINGLETON_ DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZIV_CARRIERSLOCKSINGLETON_ IMPLEMENTATION.
