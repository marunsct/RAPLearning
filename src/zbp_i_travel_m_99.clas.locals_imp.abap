...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITY zi_travel_m_99 FROM VALUE #( FOR keyval IN keys
                                                    (  %key                    = keyval-%key
...
********************************************************************************
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_travel_m_99 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_99 IN LOCAL MODE
         ENTITY travel
  ...
  METHOD CalculateTravelKey.
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_99 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
  ...
  METHOD validateAgency.
    READ ENTITY zi_travel_m_99\\travel FROM VALUE #(
