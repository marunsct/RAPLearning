CLASS zcl_generate_travel_data_99 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_99 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_99.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_99.

*   insert the new table entries
    INSERT ztravel_99 FROM TABLE @itab.
