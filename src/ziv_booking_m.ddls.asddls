...
define view entity ZIV_Booking_M
  as select from zbooking_m as Booking

  association        to parent ZIV_Travel_M   as _Travel        on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZIV_BookSuppl_M       as _BookSupplement
